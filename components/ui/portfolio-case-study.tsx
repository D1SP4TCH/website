...
import { PlantGallery } from "@/components/ui/plant-gallery";
...
const innovations: Innovation[] = [
  {
    label: "01",
    title: "Live, autosaving garden editor",
    bullets: [
  ...
  {
    label: "02",
    title: "Procedural plant biology",
    bullets: [
    ...
    <main className="-mt-24 min-h-screen bg-[#2f3731] pt-24 text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at center, rgba(157, 181, 160, 0.18) 0%, transparent 55%)",
          ...
          >
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-relaxed text-white/75 md:text-base">
                Each canvas is real, running in your browser right now. Drag to
                orbit, scroll to zoom, hit regenerate to roll a new seed.
              </p>
            </div>
